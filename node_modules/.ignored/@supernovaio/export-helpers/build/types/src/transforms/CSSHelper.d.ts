import { BorderPosition, BorderStyle, TextCase, TextDecoration, Token, Unit } from '@supernovaio/sdk-exporters';
...
import { ColorFormat } from '@supernovaio/export-helpers/build/types/src/enums/ColorFormat';
