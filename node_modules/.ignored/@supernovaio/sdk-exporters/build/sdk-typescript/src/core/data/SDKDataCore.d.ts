import { Acl } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/acl/SDKAcl";
import { Asset } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/assets/SDKAsset";
import { RenderedAsset } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/assets/SDKRenderedAsset";
import { Brand, BrandUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/base/SDKBrand";
import { DesignSystem, DesignSystemSwitcher } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/base/SDKDesignSystem";
import { DesignSystemVersion, DesignSystemVersionUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/base/SDKDesignSystemVersion";
import { DocumentationLegacy, DocumentationLegacyModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/base/SDKDocumentationLegacy";
import { Component } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/components/SDKComponent";
import { DesignComponent } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/components/SDKDesignComponent";
import { DocumentationLegacyGroup, DocumentationLegacyGroupModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/documentation/SDKDocumentationLegacyGroup";
import { DocumentationLegacyItem } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/documentation/SDKDocumentationLegacyItem";
import { DocumentationLegacyPage, DocumentationLegacyPageModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/documentation/SDKDocumentationLegacyPage";
import { ElementDataView } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/elements/SDKElementDataView";
import { ElementDataViewColumn } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/elements/SDKElementDataViewColumn";
import { ElementProperty, ElementPropertyCreationModel, ElementPropertyTargetElementType, ElementPropertyUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/elements/SDKElementProperty";
import { ElementPropertyValue } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/elements/values/SDKElementPropertyValue";
import { ConnectionProviders } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/enums/SDKConnectionProviders";
import { DocumentationEnvironment } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/enums/SDKDocumentationEnvironment";
import { TokenType } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/enums/SDKTokenType";
import { ExporterCustomBlock } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/custom_blocks/SDKExporterCustomBlock";
import { ExporterCustomBlockVariant } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/custom_blocks/SDKExporterCustomBlockVariant";
import { ExporterConfigurationProperty } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/custom_properties/SDKExporterConfigurationProperty";
import { ExportBuild } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/exporter_builds/SDKExportBuild";
import { ExportBuildResultLog } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/exporter_builds/SDKExportBuildResults";
import { ConnectionRemoteModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/remote/SDKRemoteConnectionsModel";
import { PipelineRemoteModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/remote/SDKRemotePipelineModel";
import { BitbucketPersonalAccessTokenConnectionPayload, PersonalAccessTokenConnectionPayload } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/SDKConnections";
import { Exporter } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/SDKExporter";
import { NewPipelinePayload, Pipeline } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/SDKPipeline";
import { AssetGroup } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/groups/SDKAssetGroup";
import { ComponentGroup } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/groups/SDKComponentGroup";
import { DesignComponentGroup } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/groups/SDKDesignComponentGroup";
import { TokenGroup } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/groups/SDKTokenGroup";
import { ImportJob } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/jobs/SDKImportJob";
import { Membership } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/membership/SDKMembership";
import { CustomDomain } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/support/SDKCustomDomain";
import { Source, SourceRemoteModelCloud } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/support/SDKSource";
import { TokenTheme } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/themes/SDKTokenTheme";
import { Token } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKToken";
import { User } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/users/SDKUser";
import { UserMembership } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/users/SDKUserMembership";
import { UserProfileUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/users/SDKUserProfile";
import { Workspace } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspace";
import { WorkspaceInvitation } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceInvitation";
import { WorkspaceInvoice } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceInvoice";
import { WorkspaceIPWhitelistSettings, WorkspaceIPWhitelistSettingsUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceIPWhitelistSettings";
import { WorkspaceNPMRegistrySettings, WorkspaceNPMRegistrySettingsUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceNPMRegistrySettings";
import { WorkspaceOnboarding, WorkspaceOnboardingUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceOnboarding";
import { WorkspaceProduct } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceProduct";
import { SubscriptionProductFeatures } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceProductFeatures";
import { WorkspaceProfileUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceProfile";
import { WorkspaceSSOSettings, WorkspaceSSOSettingsUpdateModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceSSOSettings";
import { WorkspaceSubscription } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/workspaces/SDKWorkspaceSubscription";
import { ComponentUpdateTransactionData, TokenUpdateTransactionData } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/core/areas/SDKAreaBulkOperations";
import { RenderedAssetRequestSettings } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/core/data/requests/SDKDataCoreRenderRequests";
import { DataBridge } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/core/data/SDKDataBridge";
...
export declare class DataCore {
    ...
    duplicateDocumentationPageOrTab(designSystemId: string, versionId: string, idInVersion: string, newPersistentId?: string): Promise<DocumentationLegacyPage>;
    /** Duplicate a documentation group or tabbed page */
    duplicateDocumentationGroupOrTabbedPage(designSystemId: string, versionId: string, idInVersion: string, newPersistentId?: string): Promise<void>;
    ...
    pipelines(workspaceId: string, designSystemId: string): Promise<Array<Pipeline>>;
    createPipeline(workspaceId: string, pipeline: NewPipelinePayload): Promise<Pipeline>;
    updatePipeline(workspaceId: string, pipeline: PipelineRemoteModel): Promise<Pipeline>;
    runPipeline(workspaceId: string, designSystemVersionId: string, pipelineId: string): Promise<Pipeline>;
    ...
    exporters(workspaceId: string, filter?: {
        installedOnly?: boolean;
    }): Promise<Array<Exporter>>;
    exportBuilds(workspaceId: string, exporterId: string, limit?: number): Promise<Array<ExportBuild>>;
    ...
    buildLogs(workspaceId: string, buildId: string): Promise<Array<ExportBuildResultLog>>;
    ...
    createPersonalAccessToken(service: ConnectionProviders, connection: PersonalAccessTokenConnectionPayload | BitbucketPersonalAccessTokenConnectionPayload): Promise<ConnectionRemoteModel>;
    ...
    importTokens(designSystemId: string, brandId: string, sourceId: string, sourceName: string, sourceType: "FigmaVariablesPlugin", payload: any): Promise<ImportJob>;
    ...
    readKeyValueStorageData(designSystemId: string, key: string): Promise<string | object | undefined>;
    setKeyValueStorageData(designSystemId: string, key: string, value: string | object): Promise<void>;
    unsetKeyValueStorageData(designSystemId: string, key: string): Promise<void>;
}
