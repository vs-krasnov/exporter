import { AnyToken, BlurType, BorderPosition, BorderStyle, DTProcessedTokenNode, GradientType, ShadowType, TokenGroup, TokenTheme } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/exports";
import { ElementProperty } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/elements/SDKElementProperty";
import { TokenType } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/enums/SDKTokenType";
import { BlurToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKBlurToken";
import { BorderToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKBorderToken";
import { ColorToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKColorToken";
import { BorderWidthToken, DimensionToken, DurationToken, FontSizeToken, LetterSpacingToken, LineHeightToken, OpacityToken, ParagraphSpacingToken, RadiusToken, SizeToken, SpaceToken, ZIndexToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKDimensionToken";
import { GradientToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKGradientToken";
import { ShadowToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKShadowToken";
import { FontFamilyToken, FontWeightToken, ProductCopyToken, StringToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKStringToken";
import { TextCaseToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKTextCaseToken";
import { TextDecorationToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKTextDecorationToken";
import { Token } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKToken";
import { AnyTokenValue, AnyMultiLayerToken, AnySingleLayerToken, BorderWidthTokenValue, ColorTokenValue, ColorValue, DimensionTokenValue, DurationTokenValue, FontFamilyTokenValue, FontSizeTokenValue, FontWeightTokenValue, LetterSpacingTokenValue, LineHeightTokenValue, OpacityTokenValue, ParagraphSpacingTokenValue, ProductCopyTokenValue, RadiusTokenValue, RawValue, SizeTokenValue, SpaceTokenValue, StringTokenValue, TextCaseTokenValue, TextDecorationTokenValue, VisibilityTokenValue, ZIndexTokenValue } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKTokenValue";
import { TypographyToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKTypographyToken";
import { VisibilityToken } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/tokens/SDKVisibilityToken";
