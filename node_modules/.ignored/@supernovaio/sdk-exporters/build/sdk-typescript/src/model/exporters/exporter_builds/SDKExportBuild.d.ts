import { ExportBuildResult } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/exporter_builds/SDKExportBuildResults";
import { ExportDestinations } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/exporters/exporter_builds/SDKExportDestinations";
export type ExportBuildCreatedByModel = {
    userId: string;
    userName: string | null;
};
export declare class ExportBuildCreatedBy {
    userId: string;
    userName: string | null;
 ...
 * @enum {string}
 */
export declare enum ExportBuildStatus {
...
/** Build run entry */
export declare class ExportBuild {
