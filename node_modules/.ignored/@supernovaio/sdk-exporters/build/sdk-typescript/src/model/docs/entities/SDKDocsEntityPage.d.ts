...
export type DocsEntityPageModel = {
    childrenIds: Array<string>;
} & DocsEntityModel;
export declare class DocsEntityPage extends DocsEntity {
    ...
    /** IDs of items belonging to the documentation group. Can be blocks and sections */
    childrenIds: Array<string>;
    constructor(model: DocsEntityPageModel);
