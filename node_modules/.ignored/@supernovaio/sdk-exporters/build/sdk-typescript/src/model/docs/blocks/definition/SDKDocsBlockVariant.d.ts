import { DocsBlockLayout } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/docs/blocks/definition/SDKDocsBlockLayout";
export type DocsBlockVariantModel = {
    id: string;
    name: string;
    image: string;
    description?: string;
...
export declare class DocsBlockVariant {
