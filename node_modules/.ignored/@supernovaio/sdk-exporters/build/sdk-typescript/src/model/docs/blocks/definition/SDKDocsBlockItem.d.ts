import { DocsBlockItemPropertyAnyDefinition } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/docs/blocks/properties/SDKDocsBlockProperty";
import { DocsBlockVariant, DocsBlockVariantModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/docs/blocks/definition/SDKDocsBlockVariant";
export type DocsBlockItemModel = {
    properties: Array<DocsBlockItemPropertyAnyDefinition>;
    appearance?: {
        isBordered?: boolean;
        hasBackground?: boolean;
    };
    variants: Array<DocsBlockVariantModel>;
    defaultVariantKey: string;
};
export declare class DocsBlockItem {
    ...
    defaultVariantKey: string;
    constructor(model: DocsBlockItemModel);
}
