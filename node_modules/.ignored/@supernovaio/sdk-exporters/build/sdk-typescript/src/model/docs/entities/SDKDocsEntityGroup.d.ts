import { DocsEntityGroupBehavior } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/enums/SDKDocsEntityGroupBehavior";
import { DocsEntity, DocsEntityModel } from "@supernovaio/sdk-exporters/build/sdk-typescript/src/model/docs/entities/SDKDocsEntity";
export type DocumentationEntityGroupModel = {
    isRoot: boolean;
...
export declare class DocsEntityGroup extends DocsEntity {
    ...
    constructor(model: DocumentationEntityGroupModel);
